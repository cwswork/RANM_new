...
class load_KGs_data(object):
    def __init__(self, myconfig):
        ...
        self.train_links = fileUtil.get_links_ids(myconfig.datasetPath[:-5] + myconfig.dataset_division + 'train_links',
                                      kg1_entity2index, kg2_entity2index)
        self.test_links = fileUtil.get_links_ids(myconfig.datasetPath[:-5] + myconfig.dataset_division + 'test_links',
                                         kg1_entity2index, kg2_entity2index)
    ...
    def pre_reldata(self, ent_embed, myconfig):
        ...
        ent_pad_id, rel_pad_id = self.kg_E, self.kg_R # 空白邻居的实体和关系ID
